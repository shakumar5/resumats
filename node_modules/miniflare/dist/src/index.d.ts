...
export declare const PLUGINS: {
    ...
    "web-search": Plugin_2<z.ZodObject<{
...
export declare const WEB_SEARCH_PLUGIN: Plugin<typeof WebSearchOptionsSchema>;

export declare const WEB_SEARCH_PLUGIN_NAME = "web-search";
